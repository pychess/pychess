...
ATOMICCHESS, BUGHOUSECHESS, CRAZYHOUSECHESS, SUICIDECHESS, \
WILDCASTLECHESS, WILDCASTLESHUFFLECHESS = range(24)

UNSUPPORTED = (BUGHOUSECHESS, SUICIDECHESS)
...
WON_ADJUDICATION, WON_CALLFLAG, WON_DISCONNECTION, WON_MATE, WON_RESIGN, \
    WON_NOMATERIAL, WON_KINGEXPLODE, \
WHITE_ENGINE_DIED, BLACK_ENGINE_DIED, DISCONNECTED, UNKNOWN_REASON = range(34)
...
KNIGHT_PROMOTION, BISHOP_PROMOTION, ROOK_PROMOTION, QUEEN_PROMOTION, NULL_MOVE, DROP = range(10)
