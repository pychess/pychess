...
WILDCASTLECHESS, WILDCASTLESHUFFLECHESS, KINGOFTHEHILLCHESS, \
ASEANCHESS, MAKRUKCHESS, SITTUYINCHESS, KAMBODIANCHESS, AIWOKCHESS, \
EUROSHOGICHESS = range(32)
...
UNSUPPORTED = (BUGHOUSECHESS, KAMBODIANCHESS, AIWOKCHESS, EUROSHOGICHESS)
