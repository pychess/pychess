...
__desc__ = _("Solve puzzles")


# TODO: get it from a text file
PUZZLES = (
    ("/home/tamas/pychess/lectures/lichess.pgn", "Charles XII at Bender"),
    ("/home/tamas/pychess/lectures/mate_in_three.pgn", "Mate in three"),
)
...
class Sidepanel():
    def load(self, persp):
        ...
        for title, path in PUZZLES:
            self.store.append([title, path])
