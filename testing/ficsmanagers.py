...
class SeekManagerTests(EmittingTestCase):
    ...
    def test7(self):
        ...
        lines = [
            ...
            "<sr> 8 17 30", "Your seeks have been removed.", BLOCK_END
        ]
        self.runAndAssertEquals('our_seeks_removed', lines, ())

    def test8(self):
        lines = [
            BLOCK_START + '62' + BLOCK_SEPARATOR + '155' + BLOCK_SEPARATOR +
            "Updating seek ad 105 to automatic.", "", "<sr> 105", "",
    ...
    def test9(self):
        lines = [
            ...
            "Updating seek ad 12; rating range now 0-9999.", "", "<sr> 12", "",
            "<sn> 12 w=mgatto ti=00 rt=1640  t=3 i=0 r=r tp=wild/4 c=? rr=0-9999 a=f f=f",
            "Your seek has been posted with index 12.",
            "(11 player(s) saw the seek.)", BLOCK_END
        ]
        self.runAndAssertEquals('seek_updated', lines,
                                ('to manual; rating range now 0-9999', ))
    ...
    def test10(self):
        ...
        lines = [
            ...
            "fics%", "Your seek matches one already posted by BugMashine.",
            "Issuing match request since the seek was set to manual.",
...
class BoardManagerTests(EmittingTestCase):
    ...
    def test3(self):
        lines = [
            ...
            "<sr> 89", "fics%", "<sr> 90",
            "fics% Challenge to archmagician withdrawn.", "", "<pr> 11",
            "fics%",
    ...
    def test4(self):
        lines = [
            ...
            BLOCK_START + '172' + BLOCK_SEPARATOR + '155' + BLOCK_SEPARATOR,
            "Your seek matches one already posted by suugakusya.", "",
            "<sr> 89", "fics% Challenge to archmagician withdrawn.", "",
            "<pr> 11", "fics%",
            "Creating: gbtami (1529) suugakusya (1425) rated blitz 5 5",
            "{Game 101 (gbtami vs. suugakusya) Creating rated blitz match.}",
            "",
    ...
    def test5(self):
        lines = [
            ...
            "Your seek matches one already posted by chemo.", "", "<sr> 6",
            "fics%", "Challenge from yms removed.", "", "<pr> 39", "fics%",
    ...
    def test6(self):
        lines = [
            self.match_offer(53),
            BLOCK_START + '172' + BLOCK_SEPARATOR + '155' + BLOCK_SEPARATOR,
            "Your seek matches one already posted by fabk.", "", "<sr> 93 71",
            "fics%", "<pr> 53", "fics%",
    ...
    def test7(self):
        lines = [
            BLOCK_START + '111' + BLOCK_SEPARATOR + '155' + BLOCK_SEPARATOR,
            "Your seek qualifies for antiseptic's getgame.", "", "<sr> 145",
            "fics%",
    ...
    def test8(self):
        lines = [
            BLOCK_START + '111' + BLOCK_SEPARATOR + '155' + BLOCK_SEPARATOR,
            "Your seek qualifies for opmentor's getgame.", "", "<sr> 179",
            "fics%", "<sr> 3", "fics%",
    ...
    def test9(self):
        lines = [
            ...
            "Your seek qualifies for opmentor's getgame.", "", "<sr> 33",
            "fics% Challenge to georgespock withdrawn.", "", "<pr> 6", "fics%",
    ...
    def test10(self):
        lines = [
            self.match_offer(14), self.match_offer(9),
            BLOCK_START + '110' + BLOCK_SEPARATOR + '155' + BLOCK_SEPARATOR,
            "Your seek matches one already posted by Strix.", "",
            "<sr> 68 105", "fics%", "<sr> 89",
            "fics% Challenge to yunger withdrawn.", "", "<pr> 14",
            "fics% Challenge to joranday withdrawn.", "", "<pr> 9", "fics%",
    ...
    def test11(self):
        lines = [
            ...
            "<sr> 125 127", "fics%", "<sr> 109", "fics%",
            "Challenge from Deji withdrawn.", "", "<pr> 12", "fics%",
    ...
    def test12(self):
        lines = [
            ...
            "Your challenge intercepts pianazo's challenge.", "", "<pr> 4",
            "fics%", "Creating: gbtami (1475) pianazo (1520) rated blitz 3 0",
    ...
    def test13(self):
        lines = [
            self.match_offer(25),
            BLOCK_START + '321' + BLOCK_SEPARATOR + '73' + BLOCK_SEPARATOR,
            "Your challenge intercepts clisus's challenge.", "", "<sr> 117",
            "fics%", "<pr> 25", "fics%",
    ...
    def test15(self):
        ...
        lines = [
            ...
            '  2.  Nf3     (0:00.000) ',
            '      {White lost connection; game adjourned} *', 'fics% '
        ]
...
class GamesTests(EmittingTestCase):
    ...
    def test1(self):
        ...
        lines = [
            ...
            "Sorry, game 12 is a private game.", BLOCK_END
        ]
...
class OfferManagerTests(EmittingTestCase):
    ...
    def test4(self):
        ...
        expectedResult = FICSChallenge(39,
    ...
    def test6(self):
        ...
        expectedResult = FICSChallenge(7, FICSPlayer('GuestFQPB'), 0, 0, False,
                                       "black", GAME_TYPES["untimed"])
        self.runAndAssertEquals('onChallengeAdd', lines, (expectedResult, ))
...
class ConsoleManagerTests(EmittingTestCase):
    ...
    def test1(self):
        ...
        lines = [
            ...
            "Finger of mgatto:", "", "On for: 44 mins   Idle: 0 secs", "",
