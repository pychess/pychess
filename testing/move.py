...
class MoveTestCase(unittest.TestCase):
    ...
    def test_wildcastle(self):
        ...
        board.applyFen("r2k2br/pppq1ppp/3b4/3n4/1n1NQ3/3B4/PPP2PPP/RNBK3R w KQkq - 3 11")
        ...
        # print("O-O-O d1f1")
        # print(board)
        self.assertEqual(board.asFen(), 'r2k2br/pppq1ppp/3b4/3n4/1n1NQ3/3B4/PPP2PPP/RNB1RK2 b kq - 4 11')
        ...
        # print("O-O d8b8")
        # print(board)
        self.assertEqual(board.asFen(), '1kr2bnr/pppn1ppp/4b3/4q3/4B3/2N5/PPP2PPP/R1BQK1NR w KQ - 3 8')
